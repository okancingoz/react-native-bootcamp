...
//fiyatı 200 den büyük
const filteredList = products.filter((item) => {
  return item.unitPrice > 200;
});
console.log(filteredList);

//fiyatı 300 den küçük
const filteredList2 = products.filter((item) => {
  return item.unitPrice < 300;
});
console.log(filteredList2);

//fiyatı 100-200 arasındakiler
const filteredList3 = products.filter((item) => {
  return item.unitPrice > 100 && item.unitPrice < 200;
});
console.log(filteredList3);

//fiyatı 20 den küçük ürünler
const filteredList4 = products.filter((item) => {
  return item.unitPrice < 20;
});
console.log(filteredList4.length);

//ismi a harfi ile başlayan ürünler
const filteredList5 = products.filter((item) => {
  return item.name.startsWith("A");
});
console.log(filteredList5);

//adında x geçen ürünler
const filteredList6 = products.filter((item) => {
  return item.name.includes("x");
});
console.log(filteredList6);
